...
const About = () => {
	return (
		<section id="about" className={styles.about}>
			<Image
				src="/about.png"
				alt="Foto da entrada da cafeteria. É possível ver muitas plantas, dando um ar natural ao espaço, misturando-se aos detalhes em madeira."
				title="Sobre nós"
				width={500}
				height={400}
			/>
			<div className={styles.content}>
				<h2 className="title light-bg">Conheça mais sobre o Bubble Coffee.</h2>
				<p>
